...
class SubCategoriaTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "SubCategorias"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as! SubCategoriaTableViewCell
        
            let item = listaSubCategorias[indexPath.row]
            cell.nomeSubCtegoria.text = item
